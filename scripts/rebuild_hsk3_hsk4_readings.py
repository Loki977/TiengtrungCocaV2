...
HSK3_TOPICS = {
    1: {
        ...
        "body": "Cam和Coca准备开一家小咖啡店。Cam喜欢安静的古典音乐，认为客人听着名曲会更放松；Coca却觉得年轻人更爱流行歌曲，歌词也容易记住。两个人争了半天，谁也不愿意改变意见。后来，他们决定做一个小实验：上午播放民歌，下午播放流行音乐，晚上再换成钢琴曲。三天以后，他们发现客人最关心的不是音乐种类，而是咖啡好不好喝、说话方不方便。从那以后，两个人不再比较谁的爱好更好，而是每天根据时间和客人的需要安排音乐。",
    ...
    3: {
        "chineseTitle": "冬衣交换角",
        "body": "冬天快到了，学校里的国际学生开始准备厚衣服。有人买了新大衣，也有人发现去年的衣服已经不能穿。Coca提出在宿舍楼下设一个“冬衣交换角”：大家把干净但不需要的帽子、围巾和外套放在那里，需要的人可以免费拿走。开始时，有些同学觉得不好意思，担心别人认为自己没有钱。后来老师先放了一件自己的大衣，还写了一张纸条：“让一件衣服继续保暖，比让它一直躺在箱子里更有意义。”几天以后，交换角不但装满了衣服，也贴满了感谢卡。",
        "answer": "Góc đổi áo mùa đông giúp đồ cũ tiếp tục hữu ích và khiến sinh viên biết chia sẻ với nhau.",
    },
    4: {
        "chineseTitle": "最后一班车还没开",
        "body": "晚上，Cam和Coca跑到车站时，最后一班车马上就要开了。Coca已经上车，Cam却突然发现钱包不见了。他想回刚才的商店找，又怕来不及。司机知道以后没有马上关门，而是让其他乘客先坐好。就在这时，一位老人从后面赶来，手里拿着Cam的钱包。原来Cam买水时把钱包落在了柜台上。Cam连声感谢，老人只说：“下次别跑得这么急，越着急越容易忘东西。”车终于开了，虽然晚了两分钟，却没有一个乘客抱怨。大家都觉得，等回一个钱包比准时两分钟更重要。",
        "answer": "Chuyến xe chờ thêm hai phút để Cam nhận lại ví, cho thấy sự giúp đỡ quan trọng hơn chút chậm trễ.",
    },
    5: {
        "chineseTitle": "公园里的黄河钢琴曲",
        "body": "周日早上，Coca在公园听见有人用旧钢琴演奏《黄河》。弹琴的是一位头发很白的老人，旁边只有几个孩子。老人说，他年轻时是音乐老师，退休以后每周都来这里弹一小时。钢琴虽然旧，有些声音也不够准，但他希望没有机会进音乐厅的人也能听到好音乐。一位小女孩问他为什么总弹同一首曲子。老人笑着说，每次天气、听众和心情都不同，所以同一首曲子也不会完全一样。演奏结束后，越来越多的人停下来鼓掌，公园像一个没有门票的小音乐厅。",
        "answer": "Âm nhạc trở nên có ý nghĩa khi được chia sẻ, ngay cả với một cây đàn cũ trong công viên.",
    },
    6: {
        "chineseTitle": "跟错旅游团以后",
        "body": "Cam第一次参加旅游团，导游让大家记住黄色的小旗。到了景点，他忙着拍照，抬头看见一面黄色的旗，就急忙跟了过去。走了十分钟，他才发现周围的人都说另一种语言，导游也不是原来的导游。幸好对方听懂了“我跟错团了”，马上帮他给自己的导游打电话。回到队伍后，朋友们都笑他只记住了颜色，没有看清旗子上的名字。Cam并不生气，还主动把这次经历讲给大家听。从那以后，他不仅跟着旗子走，也会记下集合地点和导游的号码。",
    ...
    8: {
        ...
        "body": "父亲送给Cam的眼镜用了很多年。有一天镜腿突然坏了，朋友劝他直接买一副新的，他却拿到小店去修。师傅看了以后说，旧零件已经很难找到，就算修好也可能很快再坏。Cam有些失望，因为这副眼镜让他想起父亲陪自己第一次配眼镜的下午。师傅想了想，把还能使用的镜框清理干净，装进一个透明的小盒子，又帮他选择了一副更轻的新眼镜。Cam戴着新眼镜看得更清楚，也把旧眼镜留在书桌上。他懂得，珍惜回忆不一定要继续使用旧东西，也可以好好保存它的故事。",
        "answer": "Có thể gìn giữ kỷ niệm theo cách mới thay vì buộc phải tiếp tục dùng một món đồ đã hỏng.",
    },
    9: {
        "chineseTitle": "门上的钥匙",
        "body": "晚上十一点，楼上的邻居敲Cam的门，说他的钥匙还插在外面的锁上。Cam吃了一惊，赶快把钥匙取下来。他想起回家时一手拿着菜，一手接电话，开门以后就把这件事忘了。邻居没有批评他，只提醒他这样很不安全。第二天，Cam在门里面贴了一张小纸条：“关门、取钥匙、看手机。”开始几天，他每次出门都认真读一遍。过了一个月，这三个动作已经成了习惯。那张纸条虽然不再需要，他还是没有拿掉，因为它也提醒他：生活中的很多麻烦，并不是大问题，而是少做了一个小动作。",
    ...
    16: {
        ...
        "body": "公司组织爬山，Cam一开始很有信心，觉得自己一定能第一个到山顶。走到一半，一位同事脚疼，只能放慢速度。其他人继续往上走，Cam犹豫了一会儿，决定留下来陪他。他们边走边休息，最后没有赶上山顶的合影，却在半山看到了一片很安静的云海。同事一直向Cam道歉，Cam却说：“我原来只想证明自己爬得快，现在发现一起安全回来更重要。”下山后，大家把半山的照片也放进活动纪念册。一次旅行不只有一个成功标准，有时照顾同伴也是到达。",
    ...
    17: {
        ...
        "body": "整理书桌时，Coca发现一张已经退色的车票，却怎么也想不起那次旅行。票上只有日期和城市，没有照片。她给当年同行的朋友发消息，朋友提醒她，那天火车晚点，他们在车站帮助一位老人找到了家人。Coca慢慢记起，老人为了感谢他们，送了两只很小的橘子。她一直以为重要记忆需要很多照片，后来才发现，一张普通车票、一个味道或者一句话都可能打开过去。她在票的背面写下事情的经过，再把它放进新的笔记本。保存记忆，不只是留下物品，也要及时写下物品背后的故事。",
    ...
    20: {
        ...
        "body": "考试前，Cam听说数字八很幸运，便专门选择八号座位，还把八支笔放进书包。Coca问他复习得怎么样，他却说只要号码好，题目也会容易。考试开始后，Cam发现真正有用的不是八支笔，而是前一天认真看过的语法。遇到不会的题时，他先做简单的，再回来思考，最后按时完成。成绩出来后，他考得不错，却没有说这是幸运号码的功劳。他把多余的笔分给同学，还在本子上写道：喜欢某个数字可以让人心情好，但不能代替准备、方法和努力。真正可靠的幸运，是自己已经做好了应该做的事。",
...
HSK4_TOPICS = {
    ...
    5: {
        ...
        "body": "Coca准备买一把旅行用的伞。商场里最贵的伞看起来很漂亮，广告也说使用了新材料；旁边一把价格只有一半，样子普通，却更轻，收起来也更小。售货员没有急着推荐，而是问她常去哪里、行李有多重、是否经常遇到大风。Coca试了几次，最后选择了便宜的那把。朋友开始觉得她错过了流行款，旅行回来后却发现这把伞正好能放进小包，下雨时也足够结实。购物的标准不应该只由价格决定。了解自己的实际需要，比较质量和使用场景，才能买到真正合适的东西。",
